...
async def test_men_state_check_status(storage, bot):
    ...
    message.answer.assert_called_once_with("Здесь вы можете оставить свой никнейм "
                                           "в любой из соц сетей\n"
                                           "либо нажмите на кнопку ниже если хотите "
                                           "оставить только телеграм.",
                                           reply_markup=menu)
